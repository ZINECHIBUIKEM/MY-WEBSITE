...
export function PortfolioDisplay({ lightmode }) {
  ...
  const y3 = useTransform(scrollYProgress, [0, 1], [0, -210]);
    ...
    >
      ...
      <a href="https://weather-app-zinecast.vercel.app/" target="_blank">
        <div className="flex flex-col gap-[5vh] items-center justify-between h-[50vh] w-[30vw] shrink-0">
          ...
          <motion.div style={{ y: y1 }} className="transition-all duration-300 min-w-35 max-w-70">
            <img src={Weather1} className="rounded-3xl" />
          </motion.div>
          ...
          <motion.div style={{ y: y1 }} className="transition-all duration-300 min-w-35 max-w-70">
            <img src={NW3} className="rounded-3xl -105" />
          </motion.div>

          <motion.div style={{ y: y1 }} className="transition-all duration-300 min-w-35 max-w-70">
            <img src={Weather1} className="rounded-3xl -105" />
          </motion.div>
        </div>
      </a>
      ...
      <a href="https://zinechibuikem.github.io/BLUE-MAIL-PROJECT/" target="_blank">
        <div className="flex flex-col gap-[5vh] items-center justify-between h-[50vh] w-[30vw] shrink-0">
          ...
          <motion.div style={{ y: y3 }} className="transition-all duration-300 min-w-35 max-w-70 -105">
      ...
      <a href="https://weather-app-zinecast.vercel.app/" target="_blank">
        <div className="flex flex-col gap-[5vh] items-center justify-between h-[50vh] w-[30vw] shrink-0">
          ...
          <motion.div style={{ y: y2 }} className="transition-all duration-300 min-w-35 max-w-70 -105">
