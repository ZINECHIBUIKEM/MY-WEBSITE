    ...
    <>
      <div className={`fixed flex flex-col items-start px-[8vw] pt-[12vh] backdrop-blur-lg transition-all ease-in-out duration-500 right-0 top-0 w-[80vw] h-screen lg:w-[50vw] ${lightmode ? "bg-white/90 text-black" : "bg-[#1D1D1F]/90 text-white"} h-screen z-10 ${isOpen ? "" : "translate-x-310"}`}>
        ...
        <div className="flex flex-col items-start gap-2 pb-10 w-full">
          ...
          <h3 className="transition-all ease-in-out duration-300 cursor-pointer opacity-70 hover:opacity-100">+234 810 108 9190</h3>
          <h3 className="transition-all ease-in-out duration-300 cursor-pointer opacity-70 hover:opacity-100">Etukemkachibuikem@gmail.com</h3>
          <h3 className="transition-all ease-in-out duration-300 cursor-pointer opacity-70 hover:opacity-100">Imo, Nigeria.</h3>
        </div>
      ...
      {lightmode ? <div className={`hidden transition-all ease-in-out duration-300 top-0 right-0 z-0 w-screen h-screen ${isOpen ? "bg-white/80 opacity-100" : "bg-black/0"}`} onClick={closeRightbar} /> : <div className={`hidden transition-all ease-in-out duration-300 top-0 right-0 z-0 w-screen h-screen ${isOpen ? "bg-black/80 opacity-100" : "bg-black/0"}`} onClick={closeRightbar} />}
    </>
  )
}